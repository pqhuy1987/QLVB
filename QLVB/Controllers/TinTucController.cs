    ...
    public class TinTucController : Controller
    {
        ...
        public ActionResult luuBinhLuan_ajax(string matin, string noidung)
        {
            ...
            { 
                ...
                sNoiDung += "<img width = '40' src='/Upload/Avatar/" + nv.HinhDaiDien+"' /></div>";
                sNoiDung += "<div class='hienthi-binhluan-noidung'><b>" + nv.HoTen + " </b> <span class='noidung-chinhsua' data-MaCha='" + themBL.Id + "'>" + noidung + "</span>";
                ...
                sNoiDung += "<img width='40' src='/Upload/Avatar/" + nv.HinhDaiDien + "' /> ";
